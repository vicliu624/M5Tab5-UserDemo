...
public:
  ...
  virtual int getCpuTemp() { return 0.0f; }

  /* --------------------------------- Display --------------------------------
   */
  virtual int getDisplayWidth() { return 1280; }
  virtual int getDisplayHeight() { return 720; }
  virtual void setDisplayBrightness(uint8_t brightness) {}
  virtual uint8_t getDisplayBrightness() { return 0; }
  ...
  virtual bool getChargeQcEnable() { return false; }
  virtual void setChargeEnable(bool enable) {}
  virtual bool getChargeEnable() { return false; }
  virtual void setUsb5vEnable(bool enable) {}
  virtual bool getUsb5vEnable() { return false; }
  virtual void setExt5vEnable(bool enable) {}
  virtual bool getExt5vEnable() { return false; }
  ...
  virtual bool isCameraCapturing() { return false; }
  ...
  virtual uint8_t getSpeakerVolume() { return 0; }
  // [MIC-L, AEC, MIC-R, MIC-HP]
  virtual void audioRecord(std::vector<int16_t> &data, uint16_t durationMs,
                           float gain = 80.0f) {}
  ...
  virtual MicTestState_t getDualMicRecordTestState() { return MIC_TEST_IDLE; }
  ...
  virtual MusicPlayState_t getMusicPlayTestState() { return MUSIC_PLAY_IDLE; }
  ...
  virtual bool getExtAntennaEnable() { return false; }
  ...
  virtual bool isSdCardMounted() { return false; }
  ...
  /* -------------------------------- Interface -------------------------------
   */
  virtual bool usbCDetect() { return false; }
  virtual bool usbADetect() { return false; }
  virtual bool headPhoneDetect() { return false; }
  virtual std::vector<uint8_t> i2cScan(bool isInternal) { return {}; }
 ...
 * @return hal::HalBase&
 */
inline hal::HalBase *GetHAL() { return hal::Get(); }
