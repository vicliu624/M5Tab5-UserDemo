...
public:
  ...
  inline smooth_ui_toolkit::lvgl_cpp::Container *get() { return _toast.get(); }
...
void pop_a_toast(std::string msg, toast_type::Type_t type = toast_type::info,
                 uint32_t durationMs = 1600);
