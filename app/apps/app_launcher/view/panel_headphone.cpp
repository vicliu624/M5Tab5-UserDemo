...
static const ui::Window::KeyFrame_t _kf_headphone_test_close = {-310, 301, 75,
                                                                75, 0};
static const ui::Window::KeyFrame_t _kf_headphone_test_open = {-289, 130, 403,
                                                               208, 255};
...
private:
  ...
  void update_rec_button() {
    if (GetHAL()->getHeadphoneMicRecordTestState() ==
        hal::HalBase::MIC_TEST_RECORDING) {
    ...
    } else if (GetHAL()->getHeadphoneMicRecordTestState() ==
               hal::HalBase::MIC_TEST_PLAYING) {
