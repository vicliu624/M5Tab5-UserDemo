...
static const ui::Window::KeyFrame_t _kf_rtc_setting_close = {-505, 229, 75, 75,
                                                             0};
static const ui::Window::KeyFrame_t _kf_rtc_setting_open = {-356, -12, 512, 356,
                                                            255};
...
public:
  ...
  void onOpen() override {
    ...
    _btn_ext5v_on->onClick().connect([&] {
      ...
      audio::play_tone_from_midi(GetHAL()->getExt5vEnable() ? (63 + 24)
                                                            : (60 + 24));
