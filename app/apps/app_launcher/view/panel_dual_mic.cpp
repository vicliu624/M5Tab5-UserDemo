...
static const ui::Window::KeyFrame_t _kf_mic_test_close = {-154, -318, 75, 75,
                                                          0};
static const ui::Window::KeyFrame_t _kf_mic_test_open = {-215, -217, 670, 171,
                                                         255};
...
private:
  ...
  void update_rec_button() {
    if (GetHAL()->getDualMicRecordTestState() ==
    ...
    } else if (GetHAL()->getDualMicRecordTestState() ==
