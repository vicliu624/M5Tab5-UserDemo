...
static const ui::Window::KeyFrame_t _kf_power_off_close = {562, -319, 146, 70,
                                                           0};
static const ui::Window::KeyFrame_t _kf_power_off_open = {123, -200, 703, 291,
                                                          255};
static const ui::Window::KeyFrame_t _kf_sleep_touch_wakeup_close = {562, -245,
                                                                    146, 70, 0};
static const ui::Window::KeyFrame_t _kf_sleep_touch_wakeup_open = {
    123, -200, 703, 291, 255};
static const ui::Window::KeyFrame_t _kf_sleep_shake_wakeup_close = {562, -172,
                                                                    146, 70, 0};
static const ui::Window::KeyFrame_t _kf_sleep_shake_wakeup_open = {
    123, -163, 703, 291, 255};
static const ui::Window::KeyFrame_t _kf_sleep_rtc_wakeup_close = {562, -98, 146,
                                                                  70, 0};
static const ui::Window::KeyFrame_t _kf_sleep_rtc_wakeup_open = {123, -116, 703,
                                                                 291, 255};
...
public:
  ...
  static void apply_label_header_style(Label *label, int16_t x, int16_t y,
  ...
  static void apply_label_msg_style(Label *label, int16_t x, int16_t y,
                                    const std::string &text) {
    label->align(LV_ALIGN_LEFT_MID, x, y);
    label->setTextColor(lv_color_hex(0xFFFFFF));
  ...
  static void apply_button_style(Button *btn, int16_t x, int16_t y,
...
public:
  ...
  void onOpen() override {
    apply_label_header_style(_label_header.get(), 50, -92,
                             "Your device will shut down.");

    apply_label_msg_style(
        _label_msg.get(), 50, -21,
  ...
  void onClose() override { audio::play_next_tone_progression(); }
...
public:
  ...
  void onOpen() override {
    apply_label_header_style(_label_header.get(), 50, -92,
                             "Your device will enter sleepmode.");
...
public:
  ...
  void onOpen() override {
    ...
    apply_label_msg_style(_label_msg.get(), 50, -21,
                          "It will automatically wake up in 10 seconds.");
