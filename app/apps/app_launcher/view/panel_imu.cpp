...
void PanelImu::init() {
  ...
  _label_accel_x->align(LV_ALIGN_LEFT_MID, _label_accel_x_pos_x,
                        _label_accel_x_pos_y);
  ...
  _label_accel_y->align(LV_ALIGN_LEFT_MID, _label_accel_y_pos_x,
                        _label_accel_y_pos_y);
  ...
  _label_accel_z->align(LV_ALIGN_LEFT_MID, _label_accel_z_pos_x,
                        _label_accel_z_pos_y);
...
void PanelImu::update(bool isStacked) {
  ...
  // Update dot size
  float gyro_mag = std::max({std::abs(GetHAL()->imuData.gyroX),
                             std::abs(GetHAL()->imuData.gyroY),
                             std::abs(GetHAL()->imuData.gyroZ)});
  float accel_mag = std::max({std::abs(GetHAL()->imuData.accelX),
                              std::abs(GetHAL()->imuData.accelY),
                              std::abs(GetHAL()->imuData.accelZ)});
