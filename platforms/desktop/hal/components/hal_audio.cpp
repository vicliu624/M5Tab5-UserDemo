...
uint8_t HalDesktop::getSpeakerVolume() { return _current_speaker_volume; }
...
void HalDesktop::audioRecord(std::vector<int16_t> &data, uint16_t durationMs,
                             float gain) {
...
void HalDesktop::startHeadphoneMicRecordTest() { startDualMicRecordTest(); }
