...
/*                                   System                                   */
/* -------------------------------------------------------------------------- */
void HalDesktop::delay(uint32_t ms) { SDL_Delay(ms); }

uint32_t HalDesktop::millis() { return SDL_GetTicks(); }
...
uint8_t HalDesktop::getDisplayBrightness() { return _current_lcd_brightness; }
...
bool HalDesktop::getChargeQcEnable() { return _charge_qc_enable; }
...
bool HalDesktop::getChargeEnable() { return _charge_enable; }
...
bool HalDesktop::getUsb5vEnable() { return _usba_5v_enable; }
...
bool HalDesktop::getExt5vEnable() { return _ext_5v_enable; }
...
bool HalDesktop::getExtAntennaEnable() { return _ext_antenna_enable; }

/* -------------------------------------------------------------------------- */
/*                                   SD card                                  */
/* -------------------------------------------------------------------------- */
bool HalDesktop::isSdCardMounted() { return true; }

std::vector<hal::HalBase::FileEntry_t>
HalDesktop::scanSdCard(const std::string &dirPath) {
...
void HalDesktop::uartMonitorSend(std::string msg, bool newLine) {
  ...
  std::thread([&]() {
    for (int i = 0; i < 6; i++) {
      ...
      std::string send_msg =
          "[2025-04-24 14:32:38.111] [info] [panel-com] recv msg: 32\n";
