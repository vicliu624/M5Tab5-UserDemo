...
static void _rs485_test_task(void *param) {
  ...
  while (1) {
    ...
    int len = uart_read_bytes(tab5_rs485_uart_num, data, TAB5_RS485_BUF_SIZE,
                              TAB5_RS485_PACKET_READ_TICS);
...
void HalEsp32::rs485_init() {
  ...
  ESP_ERROR_CHECK(uart_driver_install(tab5_rs485_uart_num,
                                      TAB5_RS485_BUF_SIZE * 2, 0, 0, NULL, 0));
  ...
  ESP_ERROR_CHECK(uart_set_pin(tab5_rs485_uart_num, TAB5_SYS_RS485_TX_PIN,
                               TAB5_SYS_RS485_RX_PIN, TAB5_SYS_RS485_DE_PIN,
                               UART_PIN_NO_CHANGE));

  // Set RS485 half duplex mode
  ESP_ERROR_CHECK(
      uart_set_mode(tab5_rs485_uart_num, UART_MODE_RS485_HALF_DUPLEX));

  // Set read timeout of UART TOUT feature
  ESP_ERROR_CHECK(
      uart_set_rx_timeout(tab5_rs485_uart_num, TAB5_RS485_READ_TOUT));
