...
void HalEsp32::delay(uint32_t ms) { vTaskDelay(pdMS_TO_TICKS(ms)); }

uint32_t HalEsp32::millis() { return esp_timer_get_time() / 1000; }
...
uint8_t HalEsp32::getDisplayBrightness() { return _current_lcd_brightness; }

void HalEsp32::lvglLock() { lvgl_port_lock(0); }

void HalEsp32::lvglUnlock() { lvgl_port_unlock(); }
...
void HalEsp32::setRtcTime(tm time) {
  mclog::tagInfo(_tag, "set rtc time to {}/{}/{} {:02d}:{:02d}:{:02d}",
...
bool HalEsp32::isSdCardMounted() { return true; }

std::vector<hal::HalBase::FileEntry_t>
HalEsp32::scanSdCard(const std::string &dirPath) {
...
bool HalEsp32::headPhoneDetect() { return bsp_headphone_detect(); }
