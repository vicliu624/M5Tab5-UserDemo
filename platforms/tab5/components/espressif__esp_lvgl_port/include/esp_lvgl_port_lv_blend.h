...
#warning                                                                       \
    "esp_lvgl_port_lv_blend.h included, but CONFIG_LV_DRAW_SW_ASM_CUSTOM not set. Assembly rendering not used"
#else
...
static inline lv_result_t
_lv_color_blend_to_argb8888_esp(_lv_draw_sw_blend_fill_dsc_t *dsc) {
  asm_dsc_t asm_dsc = {
...
static inline lv_result_t
_lv_color_blend_to_rgb565_esp(_lv_draw_sw_blend_fill_dsc_t *dsc) {
  asm_dsc_t asm_dsc = {
      .dst_buf = dsc->dest_buf,
      .dst_w = dsc->dest_w,
      .dst_h = dsc->dest_h,
...
static inline lv_result_t
_lv_color_blend_to_rgb888_esp(_lv_draw_sw_blend_fill_dsc_t *dsc,
...
static inline lv_result_t
_lv_rgb565_blend_normal_to_rgb565_esp(_lv_draw_sw_blend_image_dsc_t *dsc) {
