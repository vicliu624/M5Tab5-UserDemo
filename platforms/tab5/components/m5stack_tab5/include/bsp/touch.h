 ...
 * It is useful for users who want to use the touchscreen without the default
 * Graphical Library LVGL.
 *
 ...
 *
 * If you want to free resources allocated by this function, you can use
 * esp_lcd_touch API, ie.:
 *
 * \code{.c}
