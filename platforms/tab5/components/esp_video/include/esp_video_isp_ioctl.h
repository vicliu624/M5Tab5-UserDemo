...
#define V4L2_CID_USER_ESP_ISP_CCM                                              \
  (V4L2_CID_USER_ESP_ISP_BASE + 0x0000) /*!< CCM V4L2 controller ID */
#define V4L2_CID_USER_ESP_ISP_GAMMA                                            \
  (V4L2_CID_USER_ESP_ISP_BASE + 0x0001) /*!< GAMMA V4L2 controller ID */
#define V4L2_CID_USER_ESP_ISP_BF                                               \
  (V4L2_CID_USER_ESP_ISP_BASE + 0x0002) /*!< BF V4L2 controller ID */
#define V4L2_CID_USER_ESP_ISP_SHARPEN                                          \
  (V4L2_CID_USER_ESP_ISP_BASE + 0x0003) /*!< Sharpen V4L2 controller ID */
#define V4L2_CID_USER_ESP_ISP_DEMOSAIC                                         \
  (V4L2_CID_USER_ESP_ISP_BASE + 0x0004) /*!< Demosaic V4L2 controller ID */
#define V4L2_CID_USER_ESP_ISP_WB                                               \
  (V4L2_CID_USER_ESP_ISP_BASE + 0x0005) /*!< White balance V4L2 controller ID  \
                                         */
...
#define ESP_VIDEO_ISP_STATS_FLAG_HIST                                          \
  (1 << 2) /*!< ISP statistics has histogram */
#define ESP_VIDEO_ISP_STATS_FLAG_SHARPEN                                       \
  (1 << 3) /*!< ISP statistics has sharpen */
