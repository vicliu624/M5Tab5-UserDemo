 ...
 */
typedef SLIST_HEAD(esp_video_buffer_list,
                   esp_video_buffer_element) esp_video_buffer_list_t;
...
struct esp_video_buffer_info {
  ...
  uint32_t
      align_size; /*!< Buffer align size in byte, if buffer capability contains
                     of MALLOC_CAP_CACHE_ALIGNED, this value will be unused */
  uint32_t
      caps; /*!< Buffer capability: refer to esp_heap_caps.h MALLOC_CAP_XXX */
  uint32_t memory_type; /*!< Buffer memory type: refer to v4l2_memory in
                           videodev2.h. */
};
 ...
 */
struct esp_video_buffer *
esp_video_buffer_create(const struct esp_video_buffer_info *info);
 ...
 */
struct esp_video_buffer *
esp_video_buffer_clone(const struct esp_video_buffer *buffer);
 ...
 */
struct esp_video_buffer_element *
esp_video_buffer_get_element_by_buffer(struct esp_video_buffer *buffer,
                                       uint8_t *ptr);
 ...
 */
static inline uint32_t esp_video_buffer_element_get_buffer_size(
 ...
 */
static inline uint32_t esp_video_buffer_element_get_valid_size(
    struct esp_video_buffer_element *element) {
 ...
 * @return None
 */
static inline void esp_video_buffer_element_set_valid_size(
    struct esp_video_buffer_element *element, uint32_t valid_size) {
...
esp_video_buffer_element_get_buffer(struct esp_video_buffer_element *element) {
...
esp_video_buffer_element_get_index(struct esp_video_buffer_element *element) {
  return element->index;
}
 ...
 */
static inline uint32_t
esp_video_buffer_get_element_offset(struct esp_video_buffer *buffer,
                                    struct esp_video_buffer_element *element) {
  return element->index;
}
 ...
 */
static inline struct esp_video_buffer_element *
esp_video_buffer_get_element_by_offset(struct esp_video_buffer *buffer,
                                       uint32_t offset) {
