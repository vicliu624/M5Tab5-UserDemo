 ...
 */
esp_err_t
esp_video_set_ext_ctrls_to_sensor(esp_cam_sensor_device_t *cam_dev,
 ...
 */
esp_err_t
esp_video_get_ext_ctrls_from_sensor(esp_cam_sensor_device_t *cam_dev,
 ...
 */
esp_err_t
esp_video_query_ext_ctrls_from_sensor(esp_cam_sensor_device_t *cam_dev,
 ...
 *      - Others if failed
 */
esp_err_t esp_video_query_menu_from_sensor(esp_cam_sensor_device_t *cam_dev,
