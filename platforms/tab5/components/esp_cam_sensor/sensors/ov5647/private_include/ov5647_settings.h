...
#define OV5647_MIPI_CSI_LINE_RATE_800x800_50FPS                                \
  (OV5647_IDI_CLOCK_RATE_800x800_50FPS * 4)
#define OV5647_IDI_CLOCK_RATE_800x640_50FPS (100000000ULL)
#define OV5647_MIPI_CSI_LINE_RATE_800x640_50FPS                                \
  (OV5647_IDI_CLOCK_RATE_800x640_50FPS * 4)
#define OV5647_IDI_CLOCK_RATE_800x1280_50FPS (100000000ULL)
#define OV5647_MIPI_CSI_LINE_RATE_800x1280_50FPS                               \
  (OV5647_IDI_CLOCK_RATE_800x1280_50FPS * 4)
#define OV5647_IDI_CLOCK_RATE_1920x1080_30FPS (81666700ULL)
#define OV5647_MIPI_CSI_LINE_RATE_1920x1080_30FPS                              \
  (OV5647_IDI_CLOCK_RATE_1920x1080_30FPS * 5)
#define OV5647_IDI_CLOCK_RATE_1280x960_45FPS (88333333ULL)
#define OV5647_MIPI_CSI_LINE_RATE_1280x960_45FPS                               \
  (OV5647_IDI_CLOCK_RATE_1280x960_45FPS * 5)
...
static const ov5647_reginfo_t ov5647_mipi_reset_regs[] = {
    ...
    {0x4800, BIT(0)}, // Ensure streaming off to make `clock lane` go into LP-11
                      // state.
    {OV5647_REG_END, 0x00},
};
...
static const ov5647_reginfo_t
    ov5647_input_24M_MIPI_2lane_raw8_800x1280_50fps[] = {
        {0x3034, 0x18},
        {0x3035, 0x41},
...
static const ov5647_reginfo_t
    ov5647_input_24M_MIPI_2lane_raw10_1920x1080_30fps[] = {
...
static const ov5647_reginfo_t
    ov5647_input_24M_MIPI_2lane_raw10_1280x960_45fps[] = {
        ...
        {0x3803, 0x0c},
        {0x3804,
         0x0a}, // x end = 0xa27 +1 = 2600, x size = 2600 - 24 = 1288 x 2 = 2576
        {0x3805, 0x27},
        {0x3806,
         0x07}, // y end = 0x797+1 = 1944, y size = 1944 - 12 = 966 x 2 = 1932
        {0x3807, 0x97},
        {0x3811, 0x04}, // x offset: 4
        {0x3813, 0x02}, // y offset: 2
