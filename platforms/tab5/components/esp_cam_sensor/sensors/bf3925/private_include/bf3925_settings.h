...
static const bf3925_reginfo_t
    bf3925_spec_effect_regs[6][BF3925_SPEC_EFFECT_REG_SIZE] = {
        {
            {0x80, 0x0f},
            {0xd6, 0x61},
            {0xff, 0x01},
...
static const bf3925_reginfo_t DVP_8bit_20Minput_1600x1200_yuv422_9fps[] = {
    ...
    // clock，dummy
    {0xff, 0x01}, // Bit[0]: select reg page
    {0xe9, 0x2a}, // PLL setting  0x09: 1倍频   0x1b: 5/4倍频   0x2b: 3/2倍频
                  // 0x08: 2倍频  0x1a: 5/2倍频  0x2a: 3倍频
    ...
    {0xff, 0x00}, // Bit[0]: select reg page
    {0x00, 0x47}, // bit[6]: black sun control   bit[5]: mirror   bit[4]:
                  // vertical flip
    ...
    */
    ...
    {0x83, 0x27}, // 0x83[7:4]: The bigger, the smaller noise; 0x83[3:0]: The
                  // smaller, the smaller noise
    {0x84, 0xe6},
    {0x85, 0x88},
    {0x86, 0xfa},
    {0x87, 0x1a},
    ...
    {0x89, 0xca},
    {0x8b, 0x12}, // 0x8b[7:4]: Bright edge enhancement; 0x8b[3:0]: Dark edge
                  // enhancement
    ...
    {0x15,
     0x42}, // Bit[7:4]: Threshold for over exposure pixels, the smaller, the
            // more over exposure pixels; Bit[3:0]: Control the start of AE
    {0x17, 0xb5},
    {0x18, 0x30},
