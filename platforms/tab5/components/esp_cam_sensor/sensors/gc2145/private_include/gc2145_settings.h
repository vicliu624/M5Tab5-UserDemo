...
#define gc2145_settings_rgb565                                                 \
  {GC2145_REG_RESET_RELATED, 0x00}, {GC2145_REG_P0_OUTPUT_FORMAT, 0x06}

// Notes that DVP & MIPI need different YUV seq
#define gc2145_settings_yuv422                                                 \
  {GC2145_REG_RESET_RELATED, 0x00}, {GC2145_REG_P0_OUTPUT_FORMAT, 0x01}

#define gc2145_settings_yuv420                                                 \
  {GC2145_REG_RESET_RELATED, 0x00}, {GC2145_REG_P0_OUTPUT_FORMAT, 0x13}

#define gc2145_settings_1lane_stream_off                                       \
  {GC2145_REG_RESET_RELATED, 0x03}, {0x10, 0x84}

#define gc2145_settings_1lane_stream_on                                        \
  {GC2145_REG_RESET_RELATED, 0x03}, {0x10, 0x94}

#define gc2145_1lane_enable                                                    \
  {GC2145_REG_RESET_RELATED, 0x03}, {0x01, 0x83}, {0x10, 0x94}

#define gc2145_2lane_enable                                                    \
  {GC2145_REG_RESET_RELATED, 0x03}, {0x01, 0x87}, {0x10, 0x95}

static const gc2145_reginfo_t
    gc2145_antibanding[4][GC2145_ANTI_BANDING_REG_SIZE] = {
        {
            {0x05, 0x01},
            {0x06, 0x50},
            {0x07, 0x00},
...
static const gc2145_reginfo_t
    gc2145_mipi_1lane_24Minput_800x600_rgb565_30fps[] = {
        {0xfe, 0xf0},
...
static const gc2145_reginfo_t
    gc2145_mipi_1lane_24Minput_1600x1200_rgb565_7fps[] = {
        {0xfe, 0xf0},
        {GC2145_REG_DELAY, 0x09},
        {0xfc, 0x06},
        {0xf6, 0x00},
...
static const gc2145_reginfo_t
    gc2145_DVP_8bit_20Minput_640x480_yuv422_15fps_windowing[] = {
        ...
        ////////////////////  ISP reg  //////////////////////
        //////////////////////////////////////////////////////
        {0x80, 0xff}, // outdoor gamma_en, GAMMA_en, CC_en, EE_en, INTP_en,
                      // DN_en, DD_en,LSC_en
        {0x81, 0x24}, // 26//24 //BLK dither mode, ll_y_en ,skin_en, edge SA,
                      // new_skin_mode, autogray_en,ll_gamma_en,BFF test image
        {0x82, 0xfa}, // FA //auto_SA, auto_EE, auto_DN, auto_DD, auto_LSC,
                      // ABS_en, AWB_en, NA
        {0x83, 0x00}, // special_effect
        {GC2145_REG_P0_OUTPUT_FORMAT,
         0x00},       // output format [4:0] output data mode 5’h06 RGB 565
        ...
        {0x8a, 0x00}, // ISP_quiet_mode,close aaa pclk,BLK gate
                      // mode,exception,close first pipe clock,close dndd
                      // clock,close intp clock,DIV_gatedclk_en
        {0x8b, 0x00}, //[7:6]BFF_gate_mode,[5]BLK switch gain,[4]protect
                      //exp,[3:2]pipe gate mode,[1]not split sram,[0]dark
                      // current update

        {0xb0, 0x55}, // 60 //global gain
        {0xc3,
         0x00}, //[7:4]auto_exp_gamma_th1[11:8],[3:0]auto_exp_gamma_th2[11:8]
        ...
        /////////////////////////////
        {GC2145_REG_RESET_RELATED, 0x02},
        {0x80, 0xc1}, // c1 //[7]share mode [6]skin mode  [5]is 5x5 mode
                      // [1:0]noise value select 0:2  1:2.5  2:3  3:4
        {0x81, 0x08}, //
        ...
        {0x21,
         0x14}, // luma_value_div_sel(分频，与{0xef呈2倍关系，增大1，{0xef的值减小1倍)
        ...
        {0xae,
         0x0c}, //[3]EE1_effect_inc_or_dec_high,[2]EE2_effect_inc_or_dec_high,
        //[1]EE1_effect_inc_or_dec_low,[0]EE2_effect_inc_or_dec_low,  1:inc
        //0:dec

        {0xb3,
         0x34}, // 44 //ASDE_EE1_effect_slope_low,ASDE_EE2_effect_slope_low
        {0xb4,
         0x44}, // 12 //ASDE_EE1_effect_slope_high,ASDE_EE2_effect_slope_high
        ...
        {0x52,
         0x57}, // AWB_pre_THD_min[15:8] Dominiate luma 0.25=639c 0.22=57a8
        ...
        {0x69, 0x00}, // R2G_stand4[9:8] B2G_stand4[9:8] R2G_stand3[9:8]
                      // B2G_stand3[9:8]
...
static const gc2145_reginfo_t
    gc2145_DVP_8bit_20Minput_1600x1200_yuv422_13fps[] = {
        {0xfe, 0xf0},
        {GC2145_REG_DELAY, 0x09},
        {0xfc, 0x06},
        {0xf6, 0x00},
