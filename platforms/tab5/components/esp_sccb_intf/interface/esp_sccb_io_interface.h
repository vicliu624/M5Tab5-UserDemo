...
struct esp_sccb_io_t {
   ...
   */
  esp_err_t (*transmit_reg_a8v8)(esp_sccb_io_t *io_handle,
   ...
   * because the bus is busy or hardware crash.
   */
  esp_err_t (*transmit_reg_a16v8)(esp_sccb_io_t *io_handle,
   ...
   * because the bus is busy or hardware crash.
   */
  esp_err_t (*transmit_reg_a8v16)(esp_sccb_io_t *io_handle,
                                  const uint8_t *write_buffer,
                                  size_t write_size, int xfer_timeout_ms);
   ...
   * because the bus is busy or hardware crash.
   */
  esp_err_t (*transmit_reg_a16v16)(esp_sccb_io_t *io_handle,
                                   const uint8_t *write_buffer,
                                   size_t write_size, int xfer_timeout_ms);

  /**
   * @brief Perform a write-read transaction for 8-bit reg_addr and 8-bit
   * reg_val.
   *
   * @param[in] handle SCCB IO handle
   * @param[in] write_buffer Data bytes to send on the sccb bus.
   ...
   * because the bus is busy or hardware crash.
   */
  esp_err_t (*transmit_receive_reg_a8v8)(esp_sccb_io_t *io_handle,
                                         const uint8_t *write_buffer,
                                         size_t write_size,
   ...
   * because the bus is busy or hardware crash.
   */
  esp_err_t (*transmit_receive_reg_a16v8)(
      esp_sccb_io_t *io_handle, const uint8_t *write_buffer, size_t write_size,
   ...
   * because the bus is busy or hardware crash.
   */
  esp_err_t (*transmit_receive_reg_a8v16)(
      esp_sccb_io_t *io_handle, const uint8_t *write_buffer, size_t write_size,
      uint8_t *read_buffer, size_t read_size, int xfer_timeout_ms);
   ...
   * because the bus is busy or hardware crash.
   */
  esp_err_t (*transmit_receive_reg_a16v16)(
      esp_sccb_io_t *io_handle, const uint8_t *write_buffer, size_t write_size,
      uint8_t *read_buffer, size_t read_size, int xfer_timeout_ms);
