...
typedef struct {
  i2c_addr_bit_len_t
      dev_addr_length;      ///< Select the address length of the slave device
  uint16_t device_address;  ///< I2C device raw address. (The 7/10 bit address
                            ///< without read/write bit)
